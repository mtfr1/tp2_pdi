...
# knn_lbp = joblib.load('extracted_features/knn_lbp.joblib')
# knn_hist = joblib.load('extracted_features/knn_hist.joblib')
# knn_har = joblib.load('extracted_features/knn_har.joblib')